...
public class Addin {
  ...
  protected PImage profwin;
  protected PImage proflose;
  ...
  public void drawaddin() {
    ...
    profwin = p.loadImage("Profwin.png");
    profwin.resize(160,280);
    p.image(profwin,xpos-100,ypos-45);
    proflose = p.loadImage("Proflose.png");
    proflose.resize(160,240);
    p.image(proflose,xpos+100,ypos+155);
    p.fill(255);
    p.line(xpos+145,ypos+60,xpos+145,ypos+120);
    p.line(xpos+135,ypos+110,xpos+145,ypos+120);
    p.line(xpos+155,ypos+110,xpos+145,ypos+120);
  }
